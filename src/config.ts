...
export class Config {
    //public static baseContentUrl = 'http://test-widget.skyecard.com.au.s3-ap-southeast-2.amazonaws.com';    // for remote deploy
    public static baseContentUrl = 'https://d1y94doel0eh42.cloudfront.net'; 
    //public static baseContentUrl = 'https://s3-ap-southeast-2.amazonaws.com/dev-widgets.skyecard.com.au';
    ...
    // public static priceInfoUrl = Config.baseContentUrl + '/content/html/skye-responsive.html';
    ...
    public static landingInfourl = Config.baseContentUrl + '/content/html/landing.html';
